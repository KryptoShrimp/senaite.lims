-- =====================================================
-- SENAITE LIMS Database Schema - Verified Production Indexes
-- =====================================================
-- Production indexes verified against actual schema structure
-- Results are stored in senaite_analyses table, not separate results table
...
-- Sample Core Indexes (verified column names)
...
-- Analysis Core Indexes (results are stored in analyses table)
...
BEGIN
    ...
    AND table_name IN ('senaite_users', 'senaite_samples', 'senaite_analyses', 
                      ...
                      'senaite_instruments', 'senaite_audit_log');
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    RAISE NOTICE '=== SENAITE LIMS Verified Production Indexes Created ===';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '  ✓ Results stored in senaite_analyses table (not separate results table)';
    RAISE NOTICE '  ✓ All indexes verified against actual schema';
    RAISE NOTICE '  ✓ Production-ready performance optimization';
    RAISE NOTICE '  ✓ Comprehensive coverage of LIMS workflows';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Database optimized for production LIMS operations!';
END $$;